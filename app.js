...
const ui={ar:{toggle:"English",assistant:"مساعد السياسات السريرية",status:"المحادثة متصلة بمكتبة السياسات",source:"سياسة في المكتبة",newChat:"＋ محادثة جديدة",history:"المحادثات",clear:"مسح",user:"مستخدم الوزارة",question:"اكتب سؤالك عن السياسات...",meta:"الإجابات من الملفات المعتمدة فقط",enter:"Enter للإرسال",welcome:"أهلًا بك في LumaCare",welcomeText:"اسأل عن سياسة التعرف الصحيح على المريض، وسأجيبك مع الإشارة إلى المصدر.",sourceLabel:"المصدر",empty:"لا توجد محادثات بعد"},en:{toggle:"العربية",assistant:"Clinical Policy Assistant",status:"Chat uses the policy library",source:"Policy in library",newChat:"＋ New conversation",history:"Conversations",clear:"Clear",user:"Ministry user",question:"Ask a question about the policies...",meta:"Answers use approved files only",enter:"Enter to send",welcome:"Welcome to LumaCare",welcomeText:"Ask about the Correct Patient Identification Policy and I will answer with a source reference.",sourceLabel:"Source",empty:"No conversations yet"}};
const loginUi={ar:{eyebrow:"المعرفة الأقرب لقرارك",badge:"نسخة تجريبية لمنسوبي وزارة الصحة",title:"ابحث في السياسات بثقة،<br><span>ووصل للمعلومة أسرع.</span>",copy:"مساعد معرفي يجيب من الملفات المعتمدة فقط، ويحتفظ بسجل محادثاتك للعودة إليه لاحقًا.",label:"بريد تسجيل الدخول",placeholder:"أكتب إيميلك الوظيفي",login:"الدخول إلى LumaCare",trust:["جلسة تجريبية","◉ مصادر موثقة","محفوظ في هذا المتصفح"]},en:{eyebrow:"Knowledge closer to your decision",badge:"Preview for Ministry of Health staff",title:"Search policies with confidence,<br><span>and reach answers faster.</span>",copy:"A knowledge assistant that answers only from approved files and keeps your conversation history for later.",label:"Login email",placeholder:"Enter your work email",login:"Sign in to LumaCare",trust:["Preview session","◉ Cited sources","Saved in this browser"]}};
